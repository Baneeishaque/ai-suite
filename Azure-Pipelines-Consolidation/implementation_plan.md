...
Consolidate Azure Pipelines to reduce redundancy by using a shared steps template. This will ensure that the JDK 17 pipeline remains in sync with the primary (Ubuntu) pipeline, with the only difference being the JDK version.
